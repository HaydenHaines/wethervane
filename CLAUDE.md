...
| 2026-03-19 | County model extended to 2000–2024 via MEDSL presidential + Algara/Amlani governor | 3-cycle baseline (2016–2024) extended to 12 cycles (2000–2024) using free academic datasets. Adds 4 presidential pairs (2000→2004, 2004→2008, 2008→2012, 2012→2016) and 4–5 governor pairs (2002→2006, 2006→2010, 2010→2014, 2014→2018). Training dims grow from 6 to ~30. Sources: MEDSL County Presidential 2000–2024 (doi:10.7910/DVN/VOQCHQ, free, all US counties); Algara & Amlani County Electoral Dataset 1872–2020 (doi:10.7910/DVN/DGUMFI, free academic replication data, 2-party vote shares for governor at county level). AL 2018 governor structural zero preserved. |
